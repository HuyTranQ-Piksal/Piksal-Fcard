...
public class ParallaxPageTransformer implements ViewPager.PageTransformer {
    ...
    private List<ParallaxTransformInformation> viewsToParallax
    ...
    public void transformPage(View view, float position) {
        ...
        } else if (position <= 1 && viewsToParallax != null) { // [-1,1]
            for (ParallaxTransformInformation parallaxTransformInformation : viewsToParallax) {
